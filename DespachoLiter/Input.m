...
for i = 1:size(datosbarras, 1)
    PotenciaDem = PotenciaDem + datosbarras(i,7);
end

 PotenciaDem=PotenciaDem*Sbase;

%valores iniciales

lambini = 45; %Vea la condicion necesaria que tiene que cumplir lambini
              % en el archivo de lambdaiter
porcSalto = 0.5;
DespEconSP = lambdaiter(gen, PotenciaDem, lambini,porcSalto);
%------TRX--------
